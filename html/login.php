...
<html>
<head>
	<title>Web Series Hub Login</title>
	<meta charset="utf-8">
		...
		<div class="row">
			...
			<div class="col-md-4" style="background-color: white; margin-top: 40px; border-radius: 5px;">
				<form action="../functionality/userlogin.php" method="POST">
					...
					<h2 style="text-align: center;"><span style="color: #f0ad4e;">Web Series Hub</span> Sign-in</h2>
					<div class="imgcontainer">
					  ...
					  <input type="text" id="mode" name="mode" value="user" hidden>
						  
				</form><br/><br/>
				<button type="submit" class="btn btn-danger" style="float: right;"><a href="../html/adminlogin.php" style="color: white;"> Admin Sign-in</a></button>
